...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-[calc(100%-60px)] md:w-full fixed top-0 left-[60px] md:left-0 h-[72px] bg-bg dark:bg-dark justify-center items-center px-[50px] pt-[12px] md:px-[20px]">
