    ...
    <aside className="fixed flex flex-col gap-[28px] overflow-hidden left-0 top-0 h-full py-[34px] w-[80px] md:w-0 hover:w-[248px] md:hover:w-0 transition-all bg-main shadow-[0_2px_3px_3px] shadow-main-shadow  md:shadow-none">
      ...
      <ul className="flex flex-col items-start justify-start gap-[2px] py-[20px] font-semibold">
        <li className="flex justify-start items-center w-full">
          <Link title="Home" className={`w-full h-full flex items-center gap-[20px] px-[18px] py-[12px] cursor-pointer text-white transition-all hover:bg-second`} to="/">
        ...
        <li className="flex justify-start items-center w-full">
          <Link title="Tasks" className={`w-full h-full flex items-center gap-[20px] px-[18px] py-[12px] cursor-pointer text-white transition-all hover:bg-second`} to="/tasks">
